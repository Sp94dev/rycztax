...
exports.processInvoice = functions.storage.object().onFinalize(async (object) => {
  ...
  `;
    ...
    const response = await fetch(`https://us-central1-aiplatform.googleapis.com/v1/projects/rycztax/locations/us-central1/publishers/google/models/gemini-1.5-flash-001:streamGenerateContent`, {
        method: 'POST',
        headers: {
